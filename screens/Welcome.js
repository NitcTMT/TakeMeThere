    ...
    return(
        <View style={{backgroundColor:"black",height:hp("110%"),width:wp("100%")}}>
            <View style={{height:"4%"}}></View>
                <View style={{flexDirection:"row",paddingLeft:"3%",height:"1%"}}>
                  ...
                  <Image source = {require('D:/games/[FreeCourseLab.com] Udemy - React Native - The Practical Guide/NITC-Take-Me-There/StaticImages/nitcLogo.png')} style = {{ width: 50, height: 60 }} />
